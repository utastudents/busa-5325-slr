...
<form action=secondMCaccess.asp method=POST enctype="application/x-www-form-urlencoded">
   Please choose your answer, enter your computer number and click the Send button <br>

   <% 'Note that both the answer and the computer number will be checked for correct length in the secondMCaccess.asp file %>
