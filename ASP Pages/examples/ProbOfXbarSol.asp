...
<h1 align="center">Probability of Sample Mean Exercise </h1>
<br>
 <%   
   ...
   <%
    ...
    Prhtml("<p align=" & chr(34) & "center" & chr(34) & ">Identify: This is asking questions about sample averages.</p>")
  ...
  'Question 1
   ...
   function ChkAns(a,b)
    ...
    %>
Click <a href="ProbOfXbarQues.asp">here</a> for a new question
</body>
