...
<h1 align="center"> Normal Probability Exercise </h1>
<br>
 <%   
   ...
   prhtml("<p align=" & chr(34) & "center" & chr(34) & "> Your Name is = " & name & "<p>")
    ...
    PrHtml("Question 2: ") 
     ...
     PrHtml("Question 3: ") 
      if isnumeric(ans3) = true then
        ...
        If chkans(ans3,BetweenProb) =1 then
           ...
           PrHtml("Correct: The probability of finding " & obsr & " with a value of " & x & _
            " between " & lowervalue & " and " & uppervalue & " " & mea & " is " & round(BetweenProb,4) & "<br>")
     ...
     PrHtml("Question 4: ") 
      if isnumeric(ans4) = true then
        ...
        If abs(ans4-X_for_pctile) < 0.015*x_for_pctile then
         
           PrHtml("Correct: The value of " & round(X_for_pctile,2) & " falls on the " & Percentile*100 & postfix & " percentile." & "<br>")
   ...
   function ChkAns(a,b)
    ...
    %>
Click <a href="NormalProb.asp">here</a> for a new question
</body>
