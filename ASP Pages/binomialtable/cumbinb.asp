   ...
   ‘*******************
    case "A"
     ...
     'check for impossible values
        call checkX1Greater(intX1, intN)
        call checkX1Less(intX1,0)
...
Private Sub CheckX1Greater(x1, N)
    if X1 > N then 
       response.write "ERROR: Given value of X1 was too large and had to be changed! <p>"
       X1=N
    end if
...
Private Sub CheckX2Greater(x2, N)
    if X2 > N then 
       response.write "ERROR: Given value of X2 was too large and had to be changed! <p>"
       X2=N
    end if
