...
<% 
     ...
     '<META HTTP-EQUIV="refresh" CONTENT="5">
      ...
      '  call UpdateDatabase(      3,           "MCAnswers",     2,     "A",     "mcanswer",         "id")
     
      call updateDatabase(3, "Played", 2, 4)
     ...
     sub UpdateDatabase(intPlayerNumber, strTableName, intRowId, intSavedValue)
        dim strQuery
        dim strPlayer
      
        strQuery = "Select * from Played where id =" & intRowId
        ...
        strQuery = "Select * from " & strTableName & " where id =" & intRowId 
